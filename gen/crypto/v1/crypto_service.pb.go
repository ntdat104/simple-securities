...
func (x *GetServerTimeRequest) Reset() {
	*x = GetServerTimeRequest{}
	mi := &file_crypto_v1_crypto_service_proto_msgTypes[0]
...
func (*GetServerTimeRequest) Descriptor() ([]byte, []int) {
	return file_crypto_v1_crypto_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetServerTimeResponse) Reset() {
	*x = GetServerTimeResponse{}
	mi := &file_crypto_v1_crypto_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetServerTimeResponse) Descriptor() ([]byte, []int) {
	return file_crypto_v1_crypto_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetKlinesRequest) Reset() {
	*x = GetKlinesRequest{}
	mi := &file_crypto_v1_crypto_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetKlinesRequest) Descriptor() ([]byte, []int) {
	return file_crypto_v1_crypto_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetKlinesResponse) Reset() {
	*x = GetKlinesResponse{}
	mi := &file_crypto_v1_crypto_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetKlinesResponse) Descriptor() ([]byte, []int) {
	return file_crypto_v1_crypto_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *Kline) Reset() {
	*x = Kline{}
	mi := &file_crypto_v1_crypto_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Kline) Descriptor() ([]byte, []int) {
	return file_crypto_v1_crypto_service_proto_rawDescGZIP(), []int{4}
}
...
var File_crypto_v1_crypto_service_proto protoreflect.FileDescriptor

const file_crypto_v1_crypto_service_proto_rawDesc = "" +
	"\n" +
	"\x1ecrypto/v1/crypto_service.proto\x12\tcrypto.v1\x1a\x1cgoogle/api/annotations.proto\"\x16\n" +
	...
	"\tGetKlines\x12\x1b.crypto.v1.GetKlinesRequest\x1a\x1c.crypto.v1.GetKlinesResponse\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/api/v1/crypto/klinesBx\n" +
	"\rcom.crypto.v1B\x12CryptoServiceProtoP\x01Z\x0e/gen/crypto/v1\xa2\x02\x03CXX\xaa\x02\tCrypto.V1\xca\x02\tCrypto\\V1\xe2\x02\x15Crypto\\V1\\GPBMetadata\xea\x02\n" +
	"Crypto::V1b\x06proto3"

var (
	file_crypto_v1_crypto_service_proto_rawDescOnce sync.Once
	file_crypto_v1_crypto_service_proto_rawDescData []byte
)

func file_crypto_v1_crypto_service_proto_rawDescGZIP() []byte {
	file_crypto_v1_crypto_service_proto_rawDescOnce.Do(func() {
		file_crypto_v1_crypto_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_crypto_v1_crypto_service_proto_rawDesc), len(file_crypto_v1_crypto_service_proto_rawDesc)))
	})
	return file_crypto_v1_crypto_service_proto_rawDescData
}

var file_crypto_v1_crypto_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_crypto_v1_crypto_service_proto_goTypes = []any{
...
var file_crypto_v1_crypto_service_proto_depIdxs = []int32{
...
func init() { file_crypto_v1_crypto_service_proto_init() }
func file_crypto_v1_crypto_service_proto_init() {
	if File_crypto_v1_crypto_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_crypto_v1_crypto_service_proto_rawDesc), len(file_crypto_v1_crypto_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_crypto_v1_crypto_service_proto_goTypes,
		DependencyIndexes: file_crypto_v1_crypto_service_proto_depIdxs,
		MessageInfos:      file_crypto_v1_crypto_service_proto_msgTypes,
	}.Build()
	File_crypto_v1_crypto_service_proto = out.File
	file_crypto_v1_crypto_service_proto_goTypes = nil
	file_crypto_v1_crypto_service_proto_depIdxs = nil
}
